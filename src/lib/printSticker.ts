...
export const printSticker = (o: StickerOrder) => {
  ...
  if (!win) return;
  win.document.write(`<!doctype html><html><head><title>Sticker ${tracking}</title>
  <style>
    @page { size: 100mm 150mm; margin: 4mm; }
    * { box-sizing: border-box; }
    body { font-family: Inter, system-ui, sans-serif; margin:0; padding: 8px; color: #111; }
  ...
  <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Libre+Barcode+39&display=swap">
    ...
    <div class="row">
      ${o.open_package ? '<span class="badge">Ouvrir</span>' : '<span class="badge">Ne pas ouvrir</span>'}
    </div>
